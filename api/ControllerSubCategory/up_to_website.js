...
export const getDataToUpWebsite = async (app) => {
    ...
    app.get(prefixApi, helper.authenToken, async (req, res) => {
        try {
            ...
            return res.json({dataSub:dataSub,dataCategory:dataCategory,dataPromotion:dataPromotion,dataWarranty:dataWarranty})
        }
        catch (e) {
            console.log(e)
        ...
        try {
            ...
            await upload_image_branch(req, res, async (err) =>{
                ...
                try
                {
                    ...
                    for(let i = 0;i<arr_image_delete.length; i++) // xóa ảnh cần xóa
                    {
