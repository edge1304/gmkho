    ...
    for (let i = 0; i < data.length; i++){
        ...
        $("#tbodyTable").append(`
            <tr>
                ...
                <td class="right">${money(data[i].receive_money)}</td>
                <td>
...
function showEdit(index) {
    ...
    $("#popupEdit select[name=select_accounting]").val(arrData[index].receive_content).change()
    $("#popupEdit tr:nth-child(6) input").val(money(arrData[index].receive_money))
